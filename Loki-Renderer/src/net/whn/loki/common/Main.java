...
public class Main {
    ...
    public static final String LOKI_VERSION = String.format("R0.8.0.%03d", serialVersionUID);
    ...
    private static String getIoMessage(IOException ex) {
        ...
        return new StringBuilder("Loki Renderer is having IO problems with the filesystem:")
                .append(System.lineSeparator())
