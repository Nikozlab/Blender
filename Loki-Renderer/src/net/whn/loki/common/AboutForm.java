...
public class AboutForm extends LokiForm {
    ...
    private void initComponents() {
        ...
        setTitle("About Loki Rendererer");
    ...
    private JPanel buildLicensePanel() {
        ...
        String info = new StringBuilder("<html>")
                .append("Loki Renderer is free software: you can redistribute it and/or modify ")
                ...
                .append(lineSeparator)
                .append("Loki Renderer is distributed in the hope that it will be useful, ")
