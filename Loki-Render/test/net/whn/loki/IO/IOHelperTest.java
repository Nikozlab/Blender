...
public class IOHelperTest {
    ...
    public void testZipDirectory() {
        File blendFile =
                new File ("/home/nikoz/loki/XYZ123.blend");
        File lokiCfgDir = new File("/home/nikoz/.loki");
    ...
    public void testUnzipDirectory() {
        File zipFile =
                new File ("/home/nikoz/.loki/tmp/blendcache.zip");

        File tmpDir = new File("/home/nikoz/.loki/tmp/whatup?");
